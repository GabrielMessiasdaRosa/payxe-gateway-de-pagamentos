...
1. O usuário envia uma requisição POST para `/accounts` co ID único e uma API Key exclusiva
2. A conta é criada com saldo inicial zero
3. Os dados são armazenados no banco de dados
4. A resposta inclui o ID da conta e a API Key gerada
